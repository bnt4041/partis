...
**Guardar, versiones, autoguardado y exportar** viven juntos en un único menú desplegable de la barra superior (**Guardar ▾**), en vez de una fila de botones separados:
